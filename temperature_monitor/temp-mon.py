...
def write_log(temp, level):
    now = datetime.now()
    log = open("/home/pi/pi_utils/temperature_monitor/temp_mon.log", "a")
...
def send_email(email_from, email_to, subject, temp):
    ...
    try:
        os.system("echo \"Device temperature is " + str(temp) + "\'C\" | mail -s \"" + subject + "\" -A \"/home/pi/pi_utils/temperature_monitor/temp_mon.log\" -a From:" + host_name + "\<" + email_from + "\> " + email_to)
    except:
        pass
